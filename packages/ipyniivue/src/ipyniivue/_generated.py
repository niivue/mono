...
class _GeneratedNiiVue(anywidget.AnyWidget):
    ...
    def add_colormap(self, name: Any, cmap: Any) -> None:
        ...
        """
        self.send({"cmd": "addColormap", "args": [name, cmap]})
    ...
    def create_extension_context(self) -> None:
        ...
        """
        self.send({"cmd": "createExtensionContext", "args": []})
    ...
    def get_annotations_json(self) -> None:
        self.send({"cmd": "getAnnotationsJSON", "args": []})

    def get_clip_plane_depth_azi_elev(self, clip_plane_index: Any = None) -> None:
        self.send({"cmd": "getClipPlaneDepthAziElev", "args": [clip_plane_index]})

    def get_crosshair_pos(self) -> None:
        self.send({"cmd": "getCrosshairPos", "args": []})

    def get_frame_4d(self, id: Any) -> None:
        """Get the current 4D frame index for a volume.
        """
        self.send({"cmd": "getFrame4D", "args": [id]})

    def get_mesh_shader(self, mesh_index: Any) -> None:
        self.send({"cmd": "getMeshShader", "args": [mesh_index]})

    def get_tract_groups(self, mesh_index: Any) -> None:
        """Get the group names for a tract mesh.
        Returns an empty array if the mesh is not a tract or has no groups.
        """
        self.send({"cmd": "getTractGroups", "args": [mesh_index]})

    def get_volume_transform_info(self, name: Any) -> None:
        """Get metadata for a specific volume transform (options, description, resultDefaults).
        """
        self.send({"cmd": "getVolumeTransformInfo", "args": [name]})

    def has_colormap(self, name: Any) -> None:
        ...
        apply internally.
        """
        self.send({"cmd": "hasColormap", "args": [name]})
    ...
    def load_drawing(self, source: Any) -> None:
        self.send({"cmd": "loadDrawing", "args": [source]})

    def load_image(self, path_or_file: Any, options: Any = None) -> None:
        self.send({"cmd": "loadImage", "args": [path_or_file, options]})

    def load_img_v1(self, volume_index: Any, is_flip_x: Any = None, is_flip_y: Any = None, is_flip_z: Any = None) -> None:
        ...
        """
        self.send({"cmd": "loadImgV1", "args": [volume_index, is_flip_x, is_flip_y, is_flip_z]})
    ...
    def reinitialize_view(self, options: Any = None) -> None:
        self.send({"cmd": "reinitializeView", "args": [options]})
    ...
    def save_bitmap(self, filename: Any = None, quality: Any = None) -> None:
    ...
    def save_drawing(self, filename: Any = None) -> None:
        self.send({"cmd": "saveDrawing", "args": [filename]})
    ...
    def set_font(self, font: Any) -> None:
        ...
        """
        self.send({"cmd": "setFont", "args": [font]})

    def set_font_from_url(self, urls: Any) -> None:
        ...
        """
        self.send({"cmd": "setFontFromUrl", "args": [urls]})
