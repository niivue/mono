...
# Source: packages/niivue/src/NVControlBase.ts @ niivue 1.0.0-rc.13
...
class _GeneratedNiiVue(anywidget.AnyWidget):
    ...
    Mirrors NiiVue @ niivue 1.0.0-rc.13.
...
`false` stops editing but keeps the drawing visible; see `closeDrawing()`."""
    ...
    is_pan_following_crosshair = traitlets.Bool(None, allow_none=True).tag(sync=True)
...
off-window crosshair is brought back."""
    ...
    wheel_zoom_anchor = traitlets.Enum(["crosshair", "pointer"], None, allow_none=True).tag(sync=True)
